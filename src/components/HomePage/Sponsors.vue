...
<template>
<div class="logoContainer" :style="getMobileStyleContainer()">
  <img :style="getMobileStyle()" alt="Arbeit und Leben Thüringen" src="@/assets/Logos/Logo_Deine%20Vision.png" class="logoImg"/>
